<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="menuadd.aspx.cs" Inherits="menuadd" %>
        ...
        <tr>
            ...
            <td style="text-align: center">
                <asp:Button ID="btnAdd" runat="server" BorderStyle="Double" CssClass="style3" 
                    ...
                    onclick="btnAdd_Click" Text="添加" Width="104px" />
            </td>
        </tr>
    </table>
</asp:Content>
